...
# Note this requires supplying an email address.
using NEOSServer
...
#optimizer = optimizer_with_attributes(NEOSServer.Optimizer, "email" => "a0088599@gmail.com", "solver" => "OCTERACT")
#NEOSServer.Optimizer(email="a0088599@gmail.com", solver = "OCTERACT")
#optimizer = optimizer_with_attributes(BARON.Optimizer, "MaxTime" => 20.0, "AbsConFeasTol" => 1)
results_df = generate_network!(prob, EMAT, "a0088599@gmail.com", "OCTERACT"; verbose = true, cost_coeff = cost_coeff, scaling_coeff = scaling_coeff, base_cost = base_cost, save_model = true)
